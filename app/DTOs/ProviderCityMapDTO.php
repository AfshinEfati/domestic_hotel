...
class ProviderCityMapDTO
{
    public mixed $id;
    public mixed $city_id;
    public mixed $provider_id;
    public mixed $provider_city_id;
    ...
    public function __construct(
        ...
        $this->provider_city_id = $provider_city_id;
    ...
    public static function fromRequest(Request $request): self
    {
        ...
        $dto->provider_city_id = $request->input('provider_city_id');
    ...
    public function toArray(): array
    {
        ...
        if ($this->provider_city_id !== null) { $out['provider_city_id'] = $this->provider_city_id; }
