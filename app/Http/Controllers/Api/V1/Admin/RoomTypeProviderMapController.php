...
class RoomTypeProviderMapController
{
    ...
    public function index(): JsonResponse
    {
        ...
        return StatusHelper::successResponse(RoomTypeProviderMapResource::collection($data));
    }
    ...
    {
        $roomTypeProviderMap->load(['provider','roomType']);

        return StatusHelper::successResponse(new RoomTypeProviderMapResource($roomTypeProviderMap));
    }
