...
class ProviderCityMapController
{
    ...
    public function index(): JsonResponse
    {
        ...
        return StatusHelper::successResponse(ProviderCityMapResource::collection($data));
    }
    ...
    {
        $providerCityMap->load(['city','provider']);

        return StatusHelper::successResponse(new ProviderCityMapResource($providerCityMap));
    }
