...
class RoomTypeController
{
    ...
    public function index(): JsonResponse
    {
        ...
        return StatusHelper::successResponse(RoomTypeResource::collection($data));
    }
    ...
    {
        $roomType->load(['accommodation']);
        return StatusHelper::successResponse(new RoomTypeResource($roomType));
    }
