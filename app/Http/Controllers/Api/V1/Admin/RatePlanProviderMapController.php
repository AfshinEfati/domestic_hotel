...
class RatePlanProviderMapController
{
    ...
    public function index(): JsonResponse
    {
        ...
        return StatusHelper::successResponse(RatePlanProviderMapResource::collection($data));
    }
    ...
    {
        $ratePlanProviderMap->load(['provider','ratePlan']);

        return StatusHelper::successResponse(new RatePlanProviderMapResource($ratePlanProviderMap));
    }
